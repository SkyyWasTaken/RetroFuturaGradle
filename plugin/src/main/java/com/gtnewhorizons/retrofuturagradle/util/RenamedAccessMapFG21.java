...
import com.gtnewhorizons.retrofuturagradle.fg21shadow.net.md_5.specialsource.AccessMap;

public class RenamedAccessMapFG21 extends AccessMap {

    private final Map<String, String> symbolRenameMap;
    private int renameCount = 0;

    public RenamedAccessMapFG21(Map<String, String> symbolRenameMap) {
